...
from src.layer import DoubleConv, Down, OutConv, Up
...
class TestLayers(unittest.TestCase):
    ...
    def test_up_layer(self):
        ...
        channel_2 = 2
        obj = Up(
            in_channels=channel_1, out_channels=channel_1 - channel_2, bilinear=False
        )
        size_in = 280
        size_2 = 56
        ...
        # input size : (batch_size, channel_1, size_1,size_1) x (batch_size, channel_2, size_2,size_2) --> (batch_size, channel_1 - channel_2, size_2,size_2)
        self.assertEqual(
            obj.forward(img, img2).shape,
            torch.Size([1, channel_1 - channel_2, size_2, size_2 + 2]),
        )
    ...
    def test_out_conv(self):
        ...
        self.assertEqual(
            obj.forward(img).shape, torch.Size([1, 2, size_in + 2, size_in])
        )
